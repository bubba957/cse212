public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Problem in the Dequeue method. _queue[1] needed to be changed to _queue[0]
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The queue.Enqueue method was inserting at the front of the queue
        ...
        // Defect(s) Found: Could not find any errors
    }
